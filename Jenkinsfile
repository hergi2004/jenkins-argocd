...
"""
  ...
  stages {
    ...
    stage('Deploy E2E') {
      ...
      steps {
        container('tools') {
          sh "git clone https://$GIT_CREDS_USR:$GIT_CREDS_PSW@https://github.com/hergi2004/argocd-demo-deploy.git"
          sh "git config --global user.email 'hergi2004@hergi2004@gmail.com'"
